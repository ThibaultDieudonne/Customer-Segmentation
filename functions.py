...
def display_parallel_coordinates_centroids(df, num_clusters, model_name):
    '''Display a parallel coordinates plot for the centroids in df'''

    # Create the plot
    fig = plt.figure(figsize=(12, 5))
    title = fig.suptitle(f"Coordonnées parallèles pour les centroïdes du {model_name}", fontsize=18)
